...
waterButton.onclick = function () {
    ...
    displayText(waterTextMoments5, "Zuko confronts Commander Zhao in the Southern Water Tribe, marking an early encounter with key characters in the series.");
...
document.body.style.backgroundImage = "url('images/dirt.gif')";
    ...
    displayText(aardenTextMoments2, "<strong>Zuko's encounter with Toph Beifong:</strong> in season 2 bolsters his confidence and resilience as he briefly joins the Avatar's group.");
    displayText(aardenTextMoments3, "<strong>Decision to help the Avatar:</strong> Zuko's choice to aid the Avatar in 'The Crossroads of Destiny' reshapes his character as he reconsiders his relationship with his father and his pursuit of honor.");
